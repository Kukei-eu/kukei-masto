export const makeSummaryPrompt = () => `
	...
	Please make a summary of "what people are talking about" based on what you read in the posts. Respond with a list of topics, max 6 topics.

	Make sure you name actual things, do not mention generic things, only actual topics. Try to keep the summary short and prompt. Max 800 characters for everything.
